...
export IMAGE_URL=${IMAGE_URL-artifactory-artifactory.apps.rhopp241108.devcluster.openshift.com/rhtap-docker/rhtap-qe:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhopp-rhtap-testing/p9tql8dkm-java-springboot-gitops
